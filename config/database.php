    ...
    */
    ...
    'connections' => [
        ...
        'procurement' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_PROCUREMENT', '127.0.0.1'),
            'port' => env('DB_PORT_PROCUREMENT', '3306'),
            'database' => env('DB_DATABASE_PROCUREMENT', 'forge'),
            'username' => env('DB_USERNAME_PROCUREMENT', 'forge'),
            'password' => env('DB_PASSWORD_PROCUREMENT', ''),
            'unix_socket' => env('DB_SOCKET_PROCUREMENT', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'selling' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_SELLING', '127.0.0.1'),
            'port' => env('DB_PORT_SELLING', '3306'),
            'database' => env('DB_DATABASE_SELLING', 'forge'),
            'username' => env('DB_USERNAME_SELLING', 'forge'),
            'password' => env('DB_PASSWORD_SELLING', ''),
            'unix_socket' => env('DB_SOCKET_SELLING', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
