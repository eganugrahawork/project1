        ...
        <form>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        <label class="required fw-bold fs-6 mb-2">Jangka Waktu Pemabayaran</label>
            ...
            <div class="d-flex justify-content-center" id="loadingnya">
                <div class="px-2">
                    <a class="btn btn-sm btn-primary" href="/admin/procurement/retur/approve/{{ $data[0]->id_return }}"  id="btn-confirm">Setujui</a>
                </div>
                {{-- <div class="px-2">
                    <button class="btn btn-sm btn-danger" type="button" >Tolak</button>
                </div> --}}
                <div class="px-2">
