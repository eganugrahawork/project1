            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="fv-row mb-3">
                        ...
                        <label class="required form-label fw-bold fs-6 mb-2">No Invoice</label>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <textarea name="description_retur" id="description_retur" class="form-control form-control-transparent mb-3 mb-lg-0"
