            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="text" id="code" name="code" readonly
                            class="form-control form-control-transparent mb-3 mb-lg-0" value="{{ $data[0]->no_po }}" required />
                    </div>
                    <div class="fv-row mb-3">
                        <label class="fw-bold fs-6 mb-2">Tanggal Purchase Order</label>
                        <input type="text" name="order_date" id="order_date" readonly
                            class="form-control form-control-transparent mb-3 mb-lg-0" value="{{ $data[0]->order_date }}" required />
                    </div>
                    <div class="fv-row mb-3">
                        <label class="fw-bold fs-6 mb-2">Partner</label>
                        <input type="text" name="partner" id="partner" readonly
                            class="form-control form-control-transparent mb-3 mb-lg-0" value="{{ $data[0]->name }}" required />
                    </div>
                    <div class="fv-row mb-3">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="text" id="vat" value="{{ $data[0]->ppn }}" class="form-control form-control-transparent mb-3 mb-lg-0"
                            readonly required />
                    </div>
