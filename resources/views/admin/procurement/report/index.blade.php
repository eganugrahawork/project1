                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="tableReport">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-uppercase text-secondary text-md font-weight-bolder opacity-7">Total Price</th>
                                ...
                                <th class="text-uppercase text-secondary text-md font-weight-bolder opacity-7">No Invoice</th>
                                <th class="text-uppercase text-secondary text-md font-weight-bolder opacity-7">Due Date</th>
                                <th class="text-uppercase text-secondary text-md font-weight-bolder opacity-7">Lama Hari</th>
                                <th class="text-uppercase text-secondary text-md font-weight-bolder opacity-7">Due Date</th>
                                <th class="text-uppercase text-secondary text-md font-weight-bolder opacity-7">No Faktur</th>
                                <th class="text-uppercase text-secondary text-md font-weight-bolder opacity-7">Tanggal Faktur Pajak</th>
                            </tr>
                        </thead>
