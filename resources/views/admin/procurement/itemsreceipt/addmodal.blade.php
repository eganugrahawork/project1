    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="fv-row mb-7">
                ...
                <input type="text" name="do_number" id="do_number" class="form-control form-control-solid mb-3 mb-lg-0"  required/>
            </div>
            <div class="fv-row mb-7">
            ...
            <div class="fv-row mb-7">
                ...
                <input type="text" name="receipt_date" id="receipt_date" class="form-control form-control-solid mb-3 mb-lg-0"  required/>
            </div>
            <div class="fv-row mb-7">
...
<script>
    $('#purchase_order_id').on('change', function(){
        var id = $(this).val();
        $('#itemsAddList').html('<div class="spinner-grow text-success" role="status"><span class="sr-only"></span></div>')
