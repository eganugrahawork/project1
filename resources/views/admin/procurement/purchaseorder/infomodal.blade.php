<div class="d-flex justify-content-start">
   ...
   <div class="row">
        <div class="col-lg-6">
            <div class="fv-row mb-7 border-gray-300 border-bottom">
            ...
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                <label class="required form-label fw-bold">Partners</label>
                    <select class="form-select  form-select-white mb-3 mb-lg-0 select-2" disabled id="partner_id" name="partner_id" required>
            ...
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                ...
                <input type="text" name="phone" id="phone" value="{{ $info[0]->phone }}" readonly class="form-control form-control-white mb-3 mb-lg-0"  required/>
            </div>
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                <label class="fw-bold fs-6 mb-2">Fax</label>
                <input type="text" name="fax" id="fax" value="{{ $info[0]->fax }}"  readonly class="form-control form-control-white mb-3 mb-lg-0"  required/>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                <label class="required fw-bold fs-6 mb-2">Vat/PPN</label>
                <input type="number" name="ppn" id="ppn"  value="{{ $info[0]->ppn }}" class="form-control form-control-white mb-3 mb-lg-0" disabled required/>
            </div>
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                <label class="required form-label fw-bold">Currency</label>
                    <select class="form-select  form-select-white mb-3 mb-lg-0" disabled name="currency_id" id="currency_id" required>
                        <option>{{ $info[0]->currency_name }}</option>
                    </select>
            </div>
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                <label class="required fw-bold fs-6 mb-2">Rate</label>
                <input type="number" name="rate" id="rate"  value="{{ $info[0]->rate }}" disabled readonly class="form-control form-control-white mb-3 mb-lg-0"  required/>
            </div>
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                <label class="required form-label fw-bold">Term of Payment</label>
                    <select class="form-select  form-select-white mb-3 mb-lg-0 select-2" readonly name="term_of_payment" id="term_of_payment" required>
                        <option value="{{ $info[0]->term_of_payment }}">{{ $info[0]->term_of_payment }}</option>
                    </select>
            </div>
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                <label class="required fw-bold fs-6 mb-2">Description</label>
                <textarea type="text" name="description" id="description" class="form-control form-control-white mb-3 mb-lg-0" readonly required>{{ $info[0]->description }}</textarea>
            </div>
            <div class="fv-row mb-7 border-gray-300 border-bottom">
                <label class="fw-bold fs-6 mb-2">Order Date</label>
                <input type="datetime-local" name="order_date" id="order_date" readonly value="{{ $info[0]->order_date }}" class="form-control form-control-white mb-3 mb-lg-0"  required/>
            </div>
        </div>
        <div class="col-lg-12"id="itemsAddList">
            ...
            <div class="row" >
                <div class="fv-row mb-7 col-lg-3">
                    ...
                    <select class="form-select  form-select-white mb-3 mb-lg-0 item_id select-2" id="item_id" disabled name="item_id[]"  required>
                            <option>{{ $item->item_name }}</option>
                    </select>
                </div>
                <div class="fv-row mb-7 col-lg-2">
                    <label class="required fw-bold fs-6 mb-2">Price</label>
                    <input type="text" name="price[]" id="price" value="{{ $item->unit_price }}" disabled class="form-control form-control-white mb-3 mb-lg-0 qty"  required/>
                </div>
                <div class="fv-row mb-7 col-lg-2">
                    <label class="required fw-bold fs-6 mb-2">Qty</label>
                    <input type="text" name="qty[]" id="qty" value="{{ $item->qty }}" disabled class="form-control form-control-white mb-3 mb-lg-0 qty"  required/>
                </div>
                <div class="fv-row mb-7 col-lg-2">
                    <label class="required fw-bold fs-6 mb-2">Diskon</label>
                    <input type="text" name="discount[]" id="discount" value="{{ $item->discount }}" disabled class="form-control form-control-white mb-3 mb-lg-0 discount"  required/>
                </div>
                <div class="fv-row mb-7 col-lg-3">
                    <label class="required fw-bold fs-6 mb-2">Total</label>
                    <input type="text" name="total[]" id="total" value="{{ $item->total_price }}" readonly class="form-control form-control-white mb-3 mb-lg-0 totalnya"  required/>
                    <input type="hidden" name="getdiscountperitem[]" id="getdiscountperitem" value="{{ $item->total_discount }}" class="form-control form-control-white mb-3 mb-lg-0 getdiscountperitem"  required/>
                </div>
            </div>
            @endforeach
        </div>
