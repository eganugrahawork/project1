    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="fv-row mb-7">
                ...
                <select class="form-select  form-select-solid mb-3 mb-lg-0 select-2" id="partner_id" name="partner_id"
                    required>
                    @foreach ($partner as $besti)
                        <option value="{{ $besti->id }}" {{ $besti->id == $ponya[0]->partner_id ? 'selected' : '' }}>
                            {{ $besti->name }}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="col-lg-6">
            <div class="fv-row mb-7">
                ...
                <input type="number" name="ppn" id="ppn" onkeyup='sumAll()' value="{{ $ponya[0]->ppn }}"
                    class="form-control form-control-solid mb-3 mb-lg-0" required />
            </div>
            <div class="fv-row mb-7">
                <label class="required form-label fw-bold">Currency</label>
                <select class="form-select  form-select-solid mb-3 mb-lg-0 select-2" onchange="getRate(this.value)"
                    name="currency_id" id="currency_id" required>
                    @foreach ($currency as $currency)
                        <option value="{{ $currency->id }}"
                            {{ $currency->id == $ponya[0]->currency_id ? 'selected' : '' }}>{{ $currency->name }}
                        </option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="fv-row mb-7">
                ...
                <select class="form-select  form-select-solid mb-3 mb-lg-0 select-2" name="term_of_payment"
                    ...
                    <option value="other" {{ $ponya[0]->term_of_payment === 'other' ? 'selected' : '' }}>Lainnya
                    </option>
                </select>
            </div>
            <div class="fv-row mb-7">
            ...
            <div class="row">
                <div class="fv-row mb-7 col-lg-4">
                    ...
                    <div class="fv-row mb-7 col-lg-1" id="discount_parent">
                        ...
                        <input type="number" name="discount[]" id="discount" value="{{ $s_item->discount }}"
                    ...
                    <div class='fv-row mb-7 col-lg-2' id='price_parent'>
                        ...
                        <input type='number' name='price[]' id='price' onkeyup='hitungByPrice(this)'
                            value="{{ $s_item->unit_price }}" class='form-control form-control-solid mb-3 mb-lg-0'
                    ...
                    <div class="fv-row mb-7 col-lg-2">
                        ...
                        <input type="number" name="total[]" id="total" value="{{ $s_item->total_price }}"
                            readonly class="form-control form-control-solid mb-3 mb-lg-0 totalnya" required />
                        <input type="hidden" name="getdiscountperitem[]" value="{{ $s_item->total_discount }}"
                            id="getdiscountperitem" readonly
    ...
    function getBaseQty(e) {
        $.get("{{ url('/admin/procurement/purchase-order/getbaseqty') }}/" + e.value, {}, function(data) {
            ...
            $(e).parent().parent().parent().after(
                "<div class='fv-row mb-7 col-lg-1' id='base_qty_parent'><label class='fw-bold fs-6 mb-2'>Base Qty</label><input type='number' name='base_qty' id='base_qyu' class='form-control form-control-white mb-3 mb-lg-0' value='" +
