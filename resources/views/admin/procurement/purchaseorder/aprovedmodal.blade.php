...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="fv-row mb-7 border-gray-300 border-bottom">
            ...
            <select class="form-select  form-select-white mb-3 mb-lg-0" disabled name="currency_id" id="currency_id"
                required>
        ...
        <div class="fv-row mb-7 border-gray-300 border-bottom">
            ...
            <input type="datetime-local" name="order_date" id="order_date" readonly value="{{ $info[0]->order_date }}"
                class="form-control form-control-white mb-3 mb-lg-0" required />
        </div>
    </div>
        ...
        @foreach ($info as $item)
            <div class="row">
                <div class="fv-row mb-7 col-lg-3">
                    ...
                    <select class="form-select  form-select-white mb-3 mb-lg-0 item_id select-2" id="item_id" disabled
                ...
                <div class="fv-row mb-7 col-lg-2">
                    ...
                    <input type="text" name="price[]" id="price" value="{{ $item->unit_price }}" disabled
                ...
                <div class="fv-row mb-7 col-lg-2">
                    ...
                    <input type="text" name="discount[]" id="discount" value="{{ $item->discount }}" disabled
                        class="form-control form-control-white mb-3 mb-lg-0 discount" required />
                </div>
                <div class="fv-row mb-7 col-lg-3">
                    <label class="required fw-bold fs-6 mb-2">Total</label>
                    <input type="text" name="total[]" id="total" value="{{ $item->total_price }}" readonly
                        class="form-control form-control-white mb-3 mb-lg-0 totalnya" required />
...
<div class="d-flex justify-content-end py-2">
    <div class="row">
        ...
        <div class="col-lg-6 border-gray-300 border-bottom"><input type="text" readonly name="subtotal" id="subtotal"
...
<div class="d-flex justify-content-end py-2">
    <div class="row">
        ...
        <div class="col-lg-6 border-gray-300 border-bottom"><input type="text" readonly name="totaldiscount" id="totaldiscount"
                class="form-control form-control-white text-end"></div>
    </div>
</div>
<div class="d-flex justify-content-end py-2">
    <div class="row">
        ...
        <div class="col-lg-6 border-gray-300 border-bottom"><input type="text" readonly name="taxable" id="taxable"
                class="form-control form-control-white text-end"></div>
    </div>
</div>
<div class="d-flex justify-content-end py-2">
    <div class="row">
        ...
        <div class="col-lg-6 border-gray-300 border-bottom"><input type="text" readonly name="totalppn" id="totalppn"
                class="form-control form-control-white text-end"></div>
    </div>
</div>
<hr class="border border-dark border-2 opacity-50">
<div class="d-flex justify-content-end py-2">
    <div class="row">
        ...
        <div class="col-lg-6 border-gray-300 border-bottom"><input type="text" readonly name="grandtotal" id="grandtotal"
                class="form-control form-control-white text-end"></div>
    </div>
</div>
<hr class="border border-dark border-2 opacity-50">
...
<div class="d-flex justify-content-center" id="loadingnya">
    <div class="px-2">
        <a class="btn btn-md btn-success" href="/admin/procurement/purchase-order/approve/{{ $id_po }}"
            id="btn-confirm">Approve</a>
    </div>
    <div class="px-2">
    ...
    <div class="px-2">
        <button class="btn btn-md btn-primary" type="button" id="btn-close">Close</button>
    </div>
</div>
