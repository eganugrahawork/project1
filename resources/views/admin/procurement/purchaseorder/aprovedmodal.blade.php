...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="fv-row mb-7">
            ...
            <select class="form-select  form-select-solid mb-3 mb-lg-0" disabled name="currency_id" id="currency_id"
                required>
        ...
        <div class="fv-row mb-7">
            ...
            <select class="form-select  form-select-solid mb-3 mb-lg-0 select-2" readonly name="term_of_payment"
        ...
        @foreach ($info as $item)
            <div class="row">
                <div class="fv-row mb-7 col-lg-3">
                    ...
                    <select class="form-select  form-select-solid mb-3 mb-lg-0 item_id select-2" id="item_id" disabled
