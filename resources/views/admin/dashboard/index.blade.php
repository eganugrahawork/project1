            ...
            <div class="aside-menu flex-column-fluid">
                ...
                <div class="hover-scroll-overlay-y my-5 my-lg-6" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                    ...
                    <div class="card shadow-sm bg-white mb-2">
                        <div class="card-header bg-warna">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-250px w-md-300px py-3"
                                    data-kt-menu="true">
                                    <div class="menu-item px-3">
                                        <div class="menu-content pb-2 px-3 fs-7 fw-bolder text-center">Filter</div>
                                    </div>
                        ...
                        <div class="card-body">
                            <h2 class="text-gray-600">Rp.20.000.000</h2>
                        </div>
                    </div>
                    <div class="card shadow-sm bg-white mb-2">
