        ...
        <div class="col-12">
            ...
            <div class="card" id="indexContent">
                ...
                <div class="card-header border-0">
                    <div class="card-title align-items-start flex-column">
                        <div class="d-flex align-items-center position-relative my-1">
                            <h5 class="fw-bolder text-gray-600">Laba Rugi</h5>
                        </div>
                    </div>
                ...
                <div class="card-body pt-0">
                    <div class="d-flex justify-content-start col-lg-5">

                        <div class="col-lg-4">
                            <input type="text" class="form-control text-gray-400 form-control-md" name="daterange"
                                id="daterange">
                        </div>
                        <div class="col-lg-1">
                    ...
                    <div class="d-flex justify-content-end position-relative my-1">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input class="form-control" placeholder="Search" id="searchtableBukuBesarPembantu"
                                    type="text">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="text-gray-600 fw-bolder">Apa</h5>
                                </div>
                                <div class="card-body">
