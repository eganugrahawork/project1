                ...
                <div class="card-header border-0">
                    <div class="card-title align-items-start flex-column">
                        <div class="d-flex align-items-center position-relative my-1">
                            <h5 class="fw-bolder text-gray-600">Laporan Keuangan</h5>
                        </div>
                    </div>
...
@section('js')
    ...
    <script>
        ...
        function tutupContent() {
            $('#content').hide()
            $('#indexContent').show()
            $('#searchtableFinanceReport').focus();

        }

        // var tableFinanceReport = $('#tableFinanceReport').DataTable({
        //     serverside: true,
        //     processing: true,
        //     ajax: {
        ...
        // $('#searchtableFinanceReport').keyup(function() {
        //     tableFinanceReport.search($(this).val()).draw()
        // });
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            tableFinanceReport.ajax.reload(null, false);
                            $('#loading-add').html(
                                '<button type="button" class="btn btn-primary me-3" onclick="create()">Tambah Jurnal</button>'
                            )
                        }
