<div class="table-responsive">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                    <input class="form-check-input permission-menu" data-idrole="{{ $role_id }}" data-idmenu="{{ $m->id }}" data-permissiontype="edit" type="checkbox" @php
                    $data = ['role_id' => $role_id, 'menu_id' => $m->id];
            ...
            <td>
                <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                    <input class="form-check-input permission-menu" data-idrole="{{ $role_id }}" data-idmenu="{{ $m->id }}" data-permissiontype="delete" type="checkbox" @php
                    $data = ['role_id' => $role_id, 'menu_id' => $m->id];
