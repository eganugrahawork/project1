                    ...
                    <tr>
                        ...
                        <td>
                            <label class="form-check form-check-custom form-check-solid me-9">
                                <input class="form-check-input user_access" data-idrole="{{ $role_id }}"
                                    data-idmenu="{{ $m->id }}" type="checkbox"
                                    @php
$data = ['role_id' => $role_id, 'menu_id' => $m->id];
                                checkAccess($data) @endphp />
                            </label>
                                        ...
                                        <div class="row py-3">
                                            ...
                                            <div class="col-lg-3 mt-2">
                                                <label class="form-check form-check-custom form-check-solid me-9 ml-2">
                                                    <input class="form-check-input user_access"
                                                        data-idrole="{{ $role_id }}"
                                                        data-idmenu="{{ $sub->id }}" type="checkbox"
                                                        @php
$data = ['role_id' => $role_id, 'menu_id' => $sub->id];
                                            ...
                                            @foreach ($subonsubmenu as $sosm)
                                                ...
                                                <div class="col-lg-3 mt-2">
                                                    <label
                                                        class="form-check form-check-custom form-check-solid me-9 ml-2">
                                                        <input class="form-check-input user_access"
                                                            data-idrole="{{ $role_id }}"
                                                            data-idmenu="{{ $sosm->id }}" type="checkbox"
                                                            @php
