            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <select class="form-select  form-select-solid mb-3 mb-lg-0 select-2" name="selling_id"
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="text" id="sales_date" name="sales_date"
                            class="form-control form-control-solid mb-3 mb-lg-0" value="{{ $data[0]->date_selling }}"
                            readonly required />
                    </div>
                    <div class="fv-row mb-3">
                        <label class="fw-bold fs-6 mb-2">Alamat</label>
                        <textarea type="text" name="address" id="address" readonly
                            class=" form-control form-control-solid mb-3 mb-lg-0">{{ $data[0]->address }}</textarea>
                    </div>
                    <div class="fv-row mb-3">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <textarea type="text" name="ship_from" id="ship_from" class=" form-control form-control-solid mb-3 mb-lg-0" readonly>Cikutra, Bandung</textarea>
                    </div>
                    <div class="fv-row mb-3">
                        <label class="fw-bold fs-6 mb-2">Email</label>
                        <input type="email" id="email_parent" name="email_parent"
                            class="form-control form-control-solid mb-3 mb-lg-0" value="swamedia@gmail.com" readonly
                            required />
                    </div>
                    <div class="fv-row mb-3">
                        <label class="fw-bold fs-6 mb-2">Phone/Fax</label>
                        <input type="number" id="phone_fax" name="phone_fax"
                            class="form-control form-control-solid mb-3 mb-lg-0" value="089321832" readonly required />
                    </div>
                    <div class="fv-row mb-3">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="text" id="invoice_number" name="invoice_number"
                            class="form-control form-control-solid mb-3 mb-lg-0" value="{{ $data[0]->invoice_number }}"
                            required readonly />
                    </div>
                    <div class="fv-row mb-3">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="text" id="att" name="att"
                            class="form-control form-control-solid mb-3 mb-lg-0" value="{{ $data[0]->attention }}"
                            required readonly />
                    </div>
                    <div class="fv-row mb-3">
                        <label class="fw-bold fs-6 mb-2">Deskripsi</label>
                        <textarea type="text" name="description_invoice" id="description_invoice"
                            class=" form-control form-control-solid mb-3 mb-lg-0" readonly>{{ $data[0]->description }}</textarea>
                    </div>
                    <div class="fv-row mb-3">
                    ...
                    @foreach ($data as $d)
                        <div class='row'>
                            <div class='fv-row mb-3 col-lg-3'>
                                ...
                                <select class='form-select  form-select-solid mb-3 mb-lg-0 select-2' readonly
                                     required>
                            ...
                            <div class='fv-row mb-3 col-lg-1'>
                                ...
                                <input type='number' name='qty[]' id='qty'
                                    class='form-control form-control-solid mb-3 mb-lg-0' value='{{ $d->qty_satuan }}'
                            ...
                            <div class='fv-row mb-3 col-lg-1'>
                                ...
                                <input type='number' name='total_qty[]' id='total_qty' readonly
                                    class='form-control form-control-solid mb-3 mb-lg-0' value='{{ $d->qty }}' readonly required />
                            </div>
                            <div class='fv-row mb-3 col-lg-1'>
                                <label class=' fw-bold fs-6 mb-2'>Harga</label>
                                <input type='number' name='price[]' id='price'
                                    class='form-control form-control-solid mb-3 mb-lg-0' value='{{ $d->unit_price }}'
                                    onkeyup='countTotalQty(this)' readonly required />
                            </div>
                            <div class='fv-row mb-3 col-lg-2'>
                                <label class=' fw-bold fs-6 mb-2'>Total</label>
                                <input type='number' name='total_price[]' id='total_price'
                                    class='form-control form-control-solid mb-3 mb-lg-0 total_price' value='{{ $d->price }}'
                                    readonly required />
                            </div>
                            <div class='fv-row mb-3 col-lg-2'>
                                <label class=' fw-bold fs-6 mb-2'>Note</label>
                                <input type='text' name='notes[]' id='notes'
                                    class='form-control form-control-solid mb-3 mb-lg-0 notes' value="{{ $d->notes }}" readonly required />
                            </div>
                        </div>
                    @endforeach
                </div>
