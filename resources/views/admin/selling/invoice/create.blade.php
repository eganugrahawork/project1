                ...
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="email" id="email_parent" name="email_parent"
                            class="form-control form-control-solid mb-3 mb-lg-0" value="swamedia@gmail.com" readonly required />
                    </div>
                    <div class="fv-row mb-3">
...
<option>-</option>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <textarea type="text" name="description_invoice" id="description_invoice" class=" form-control form-control-solid mb-3 mb-lg-0"></textarea>
                    </div>
                    <div class="fv-row mb-3">
