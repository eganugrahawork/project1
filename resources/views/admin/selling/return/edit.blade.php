<div class="card">
    <div class="card-header">
        <h4>Perbarui Return Penjualan</h4>
    </div>
    <div class="card-body">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <div class="">
                            <input type="text" id="return_date" name="return_date"
                                class="form-control form-control-transparent mb-3 mb-lg-0" value="{{ $data[0]->retur_date }}" required />
                        </div>
                    </div>
                    <div class="fv-row mb-3">
                    ...
                    <div class='row'>
                        ...
                        <div class='fv-row mb-3 col-lg-1'>
                            ...
                            <input type='number' name='return_qty[]' id='return_qty'
                                class='form-control form-control-transparent mb-3 mb-lg-0' value='{{ $d->qty_return }}' onkeyup='countTotalQty(this)'
                                required />
                        </div>
                        <div class='fv-row mb-3 col-lg-1'>
...
<script>
    ...
    $('#updateReturn').submit(function(event) {
        ...
        swalWithBootstrapButtons.fire({
            title: 'Perbarui Data ?',
            text: "Mohon Cek Terlebih Dahulu Sebelum Menyimpan!",
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ url('/admin/selling/return/update') }}",
                    type: 'post',
                    data: $('#updateReturn')
