                    ...
                    <div class="fv-row mb-3">
                        ...
                        <div class="">
                            <input type="text" id="return_date" name="return_date"
                                class="form-control form-control-solid mb-3 mb-lg-0" value="{{ $data[0]->retur_date }}" required />
                        </div>
                    </div>
                    <div class="fv-row mb-3">
                    ...
                    <div class='row'>
                        ...
                        <div class='fv-row mb-3 col-lg-1'>
                            ...
                            <input type='number' name='return_qty[]' id='return_qty'
                                class='form-control form-control-solid mb-3 mb-lg-0' value='{{ $d->qty_return }}' onkeyup='countTotalQty(this)'
                                required />
                        </div>
                        <div class='fv-row mb-3 col-lg-1'>
