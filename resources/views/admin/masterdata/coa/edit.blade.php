                ...
                <div class="col-lg-6">
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <select class="form-select  form-select-transparent mb-3 mb-lg-0 select-2" id="id_parent"
                            name="id_parent" disabled required>
                    ...
                    <div class="fv-row mb-3">
                        ...
                        <input type="text" name="coa" id="coa"
                            class="form-control form-control-transparent mb-3 mb-lg-0" value="{{ $coa->coa }}"
                            required />
                    </div>
                    <div class="fv-row mb-3">
                        <label class="required fw-bold fs-6 mb-2">Keterangan</label>
                        <input type="text" name="description" id="description"
                            class="form-control form-control-transparent mb-3 mb-lg-0" value="{{ $coa->description }}"
                            required />
                    </div>
                    <div class="fv-row mb-3">
