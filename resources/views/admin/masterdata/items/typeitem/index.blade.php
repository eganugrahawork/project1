                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title align-items-start flex-column">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" id="searchtypeItemTable"
    ...
    <script>
        function addtypeitemsModal() {
            ...
            $.get("{{ url('/admin/masterdata/typeitems/addmodal') }}", {}, function(data, status) {
                ...
                $('#loading-add').html(
                    '<button type="button" class="btn btn-primary me-3" id="add-btn" onclick="addtypeitemsModal()">Add Type Items</button>'
                )
            });
        }
        ...
        var typeItemTable = $('#typeItemTable').DataTable({
            ...
            processing: true,
            ajax: {
                url: "{{ url('/admin/masterdata/typeitems/listtype') }}"
            },
            columns: [{
                    data: 'DT_RowIndex',
                    searchable: false
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#loading-add').html(
                                '<button type="button" class="btn btn-primary me-3" id="add-btn" onclick="addtypeitemsModal()">Add Type</button>'
                                )
                        }
                    })
