    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="fv-row mb-7">
                ...
                <div class="col-lg-8">
                    <select class="form-select  form-select-solid mb-3 mb-lg-0" name="partner_type" id="partner_type"
                        required>
        ...
        <div class="col-lg-6">
            <div class="fv-row mb-7">
                ...
                <input type="text" name="fax" id="fax" class="form-control form-control-solid mb-3 mb-lg-0"
                    required />
            </div>
            <div class="fv-row mb-7">
