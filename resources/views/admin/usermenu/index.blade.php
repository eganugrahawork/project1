                ...
                <div class="card mb-10">
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Menu 1-->
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_617b94b53a161">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    ...
                                    @foreach ($lokasi as $l)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                    <div class="menu-item px-3">
                                                        <a class="menu-link px-3" onclick="editModalLocation({{ $l->id }})" >Edit</a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                        <a href="/admin/configuration/location/delete/{{ $l->id }}" class="menu-link px-3 button-delete" data-kt-users-table-filter="delete_row">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
