                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap ">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center ">
                                        <a href="#"
                                            class="text-gray-900 text-hover-primary fs-4 fw-bolder me-1">{{ auth()->user()->name }}</a>
                                    </div>
            ...
            <div class="col-lg-6" id="profileEdit">
                <div class="card shadow mb-5 mb-xl-5" id="kt_profile_details_view">
                    <div class="card-header cursor-pointer">
                        ...
                        <a onclick="editProfile()" class="btn btn-primary align-self-center">Edit Profile</a>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-8">
                                <a href="#"
                                    class="fw-bold fs-6 text-gray-800 text-hover-primary">{{ auth()->user()->email }}</a>
                            </div>
                        </div>
                        <div class="row mb-2">
