<form id="add-form" class="form">
            ...
            <div class="col-lg-6">
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="email" name="email" onchange="checkEmail(this)"
                        ...
                        required />
                    <div class="form-text" style="color: red" id="demailmin"><i class="bi bi-x-circle-fill"></i> Harus
                        Email</div>
                    <div class="form-text" style="color: rgb(207, 207, 29)" id="demailcheck"><i
                            class="bi bi-arrow-clockwise"></i> Sedang Memeriksa</div>
                    <div class="form-text" style="color: red" id="demailcheckfalse"><i class="bi bi-x-circle-fill"></i>
                        Email sudah ada</div>
                ...
                <div class="fv-row mb-7">
                    ...
                    <select class="form-select select-2-first" data-placeholder="Select an option" name="religion"
                        required>
                        <option></option>
            ...
            <div class="col-lg-6">
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="text" name="username" onchange="checkUsername(this)"
                        class="form-control form-control-solid mb-3 mb-lg-0" required />
                    <div class="form-text" style="color: red" id="dusrmin"><i class="bi bi-x-circle-fill"></i>
    ...
    <div class="text-center pt-15">
        <button class="btn btn-light me-3" onclick="tutupModal()">Discard</button>
