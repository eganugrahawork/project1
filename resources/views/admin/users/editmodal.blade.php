    ...
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
        <div class="fv-row mb-7 text-center">
            ...
            <div class="image-input image-input-outline" data-kt-image-input="true">
                <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ URL::asset('storage/'.$user->image) }});"></div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" value="{{ $user->name }}" required/>
                </div>
                <div class="fv-row mb-7">
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="number" name="no_hp" value="{{ $user->no_hp }}" class="form-control form-control-solid mb-3 mb-lg-0"  required/>
                </div>
                <div class="fv-row mb-7">
            ...
            <div class="col-lg-6">
                <div class="fv-row mb-7">
                    ...
                    <input type="text" name="place_of_birth" class="form-control form-control-solid mb-3 mb-lg-0" value="{{ $user->place_of_birth }}" required/>
                </div>
                <div class="fv-row mb-7">
                    <label class="required fw-bold fs-6 mb-2">Tanggal Lahir</label>
                    <input type="date" name="date_of_birth" class="form-control form-control-solid mb-3 mb-lg-0" value="{{ $user->date_of_birth }}" required/>
                </div>
                <div class="fv-row mb-7">
                    <label class="required fw-bold fs-6 mb-2">Agama</label>
                    <select class="form-select form-select-solid" name="religion" required>
                        <option value="Islam" @if ($user->religion == "Islam")
                            selected
                        @endif>Islam</option>
                        <option value="Kristen" @if ($user->religion == "Kristen")
                            selected
                        @endif>Kristen</option>
                        <option value="Protestan" @if ($user->religion == "Protestan")
                            selected
                        @endif>Protestan</option>
                        <option value="Hindu" @if ($user->religion == "Hindu")
                            selected
                        @endif>Hindu</option>
                        <option value="Budha" @if ($user->religion == "Budha")
                            selected
                        @endif>Budha</option>
                        <option value="Ateis" @if ($user->religion == "Ateis")
                            selected
                        @endif>Ateis</option>
                        <option value="Lainnya" @if ($user->religion == "Lainnya")
                            selected
