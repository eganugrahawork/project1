        ...
        <div class="card-body">
            ...
            <div class="container text-center">
                <form action="/admin/users/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-2">
                        <div class="col-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nama" type="text" class="form-control @error('nama')
                                        is-invalid
                                    @enderror" name="nama" value="{{ old('nama') }}" required autocomplete="nama" autofocus>
                                    @error('nama')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    is-invalid
                                @enderror" name="alamat" required  autofocus>{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    is-invalid
                                    @enderror" value="{{ old('nokontak') }}" name="nokontak" required autocomplete="nokontak" autofocus>
                                    @error('nokontak')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" value="{{ old('email') }}" class="form-control @error('email')
                                    is-invalid
                        ...
                        <div class="col-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="lokasi" type="text" value="{{ old('lokasi') }}" class="form-control @error('lokasi')
                                    is-invalid
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="username" type="text" value="{{ old('username') }}" class="form-control @error('username')
                                    is-invalid
                            ...
                            <div class="row mb-3">
                                <label for="password" class="col-md-4 col-form-label text-md-end @error('password')
                                is-invalid
                                @enderror">Password</label>
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control @error('password')
                                        is-invalid
                                    @enderror" name="password" required autocomplete="password" autofocus>
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <img class="img-preview img-fluid" style="width:100px; height:100px; display:block; margin-left:auto; margin-right:auto;" src="{{ asset('storage/img-users/default.png') }}" >
