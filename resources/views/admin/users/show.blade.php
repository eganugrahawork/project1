...
@section('content')
    ...
    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
        <div class="content flex-row-fluid" id="kt_content">
            <div class="card shadow mb-5 mb-xl-5">
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap ">
                                <div class="d-flex flex-column">
                                    <div class="d-flex align-items-center ">
                                        <a href="#"
                                            class="text-gray-900 text-hover-primary fs-4 fw-bolder me-1">{{ $user->name }}</a>
                                    </div>
            ...
            <div class="col-lg-6" id="profileEdit">
                <div class="card shadow mb-5 mb-xl-5" id="kt_profile_details_view">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ $user->regiondetail->name }}</span>
                            </div>
                        </div>
                        <div class="row mb-2">
