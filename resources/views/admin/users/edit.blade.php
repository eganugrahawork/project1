                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="fv-row mb-3">
                            ...
                            <input type="text" name="name"
                                class="form-control form-control-transparent mb-3 mb-lg-0" value="{{ $user->name }}"
                                required />
                        </div>
                        <div class="fv-row mb-3">
                            ...
                            <div class="form-text" style="color: red" id="edemailmin"><i
                                    class="bi bi-x-circle-fill"></i> Harus
                                Email</div>
                            <div class="form-text" style="color: rgb(207, 207, 29)" id="edemailcheck"><i
                                    class="bi bi-arrow-clockwise"></i> Sedang Memeriksa</div>
                            <div class="form-text" style="color: red" id="edemailcheckfalse"><i
                        ...
                        <div class="fv-row mb-3">
                            ...
                            <select class="form-select form-select-transparent select-2" name="region" required>
                                @foreach ($region as $l)
                                    <option value="{{ $l->id }}"
                                        @if ($user->region === $l->id) selected @endif>
                                        {{ $l->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="fv-row mb-3">
                            ...
                            <select class="form-select form-select-transparent select-2" name="religion" required>
                                <option value="Islam" @if ($user->religion == 'Islam') selected @endif>Islam</option>
                                <option value="Kristen" @if ($user->religion == 'Kristen') selected @endif>Kristen
                                </option>
                                <option value="Protestan" @if ($user->religion == 'Protestan') selected @endif>Protestan
                                </option>
                                ...
                                <option value="Lainnya" @if ($user->religion == 'Lainnya') selected @endif>Lainnya
                                </option>
                            </select>
                        </div>
                        <div class="fv-row mb-3">
                            ...
                            <input type="text" name="username" value="{{ $user->username }}"
                                ...
                                class="form-control form-control-transparent mb-3 mb-lg-0" required />
                            <div class="form-text" style="color: red" id="edusrmin"><i
                                    class="bi bi-x-circle-fill"></i>
