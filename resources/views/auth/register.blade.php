            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="id_role" class="col-md-4 col-form-label text-md-end">{{ __('Role') }}</label>

                            <div class="col-md-6">
                                <input id="id_role" type="id_role" class="form-control @error('id_role') is-invalid @enderror" name="id_role" value="{{ old('id_role') }}" required autocomplete="id_role">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="alamat" type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat"  required autocomplete="alamat">{{ old('alamat') }}</textarea>
                        ...
                        <div class="row mb-3">
                            <label for="nokontak" class="col-md-4 col-form-label text-md-end">{{ __('nokontak') }}</label>

                            <div class="col-md-6">
                                <input id="nokontak" type="number" class="form-control @error('nokontak') is-invalid @enderror" name="nokontak" value="{{ old('nokontak') }}" required autocomplete="nokontak">
                        ...
                        <div class="row mb-3">
                            <label for="lokasi" class="col-md-4 col-form-label text-md-end">{{ __('Wilayah') }}</label>
                        ...
                        <div class="" data-kt-stepper-element="content">
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <select name="business_type" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select..." data-allow-clear="true" data-hide-search="true" required>
